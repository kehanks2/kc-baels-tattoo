...
INSERT INTO portfolio_images (image_url, alt_text, title, category, show_on_homepage, display_order, width, height) VALUES
    ...
    ('/assets/portfolio/images/jellyfish.jpg',  'Black and grey jellyfish with fine detailed linework tattoo',    'Jellyfish',           'black-grey', false, 2, 1080, 1350),
    ...
    ('/assets/portfolio/images/spider-lilies.jpg', 'Fine line red spider lily thigh tattoo',                         'Spider Lilies',       'color', false, 4, 3237, 4316),
